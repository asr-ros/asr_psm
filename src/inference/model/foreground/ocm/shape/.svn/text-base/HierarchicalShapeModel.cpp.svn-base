...
namespace ProbabilisticSceneRecognition {
  ...
  double HierarchicalShapeModel::calculateProbabilityForHypothesis(std::vector<pbd_msgs::PbdObject> pEvidenceList, std::vector<unsigned int> pAssignments)
  {
    double result = 1.0;
  ...
  void HierarchicalShapeModel::visualize(std::vector<pbd_msgs::PbdObject> pEvidenceList)
  {
