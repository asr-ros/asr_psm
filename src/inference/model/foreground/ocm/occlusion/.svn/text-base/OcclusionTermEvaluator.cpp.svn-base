...
namespace ProbabilisticSceneRecognition {
  ...
  void OcclusionTermEvaluator::handleSceneGraph(const boost::shared_ptr<const pbd_msgs::PbdSceneGraph>& pSceneGraph)
  {
  ...
  double OcclusionTermEvaluator::calculateProbabilityForHypothesis(std::vector<pbd_msgs::PbdObject> pEvidenceList, std::vector<unsigned int> pAssignments)
  {
    /**************************************************************************************************
  ...
  void OcclusionTermEvaluator::visualize(std::vector<pbd_msgs::PbdObject> pEvidenceList)
  {
